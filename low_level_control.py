...
"""
Class for converting the command message (-1, 1)
to convert a servo value (around a center of 333)
"""
class ServoConvert():
...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        #create a dictionary of the servos that correspond
        #to our throttle and stearing controls
        self.actuators = {}
        ...
        #appends the created converters to the servo message
